...
<style> /* Reuse Header Style */
        ...
        .btn-light { background: white; color: var(--accent-blue); padding: 8px 16px; border-radius: 4px; font-weight: 600; border: none; cursor: pointer; }
