<div class="staffs-container">
    ...
    <tbody id="staffsTableBody">
      <?php foreach ($staffs as $staff): ?>
        <tr data-user-id="<?php echo $staff['id']; ?>">
          ...
          <td>
            <img
              src="/BookMyRoom/<?php echo $staff['avatarUrl'] ?: '/public/images/avatars/default.jpg'; ?>"
              class="staffs-avatar-img">
          </td>
          ...
          <td>
            <?php if ($staff['status'] == 'PENDING'): ?>
              <button class="staffs-approve-btn btn-approve" data-user-id="<?php echo $staff['id']; ?>">Duyệt</button>
            <?php else: ?>
  ...
  <!-- Modal thêm đối tác -->
  <div id="addStaffsModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
      <div class="mt-3">
        <div class="flex items-center justify-between mb-4">
          <h3 class="text-lg font-medium text-gray-900">Thêm nhân viên mới</h3>
          <button id="closeModal_staff" class="text-gray-400 hover:text-gray-600">
            <span class="text-2xl">&times;</span>
          </button>
        </div>

        <form id="addStaffsForm" method="POST" action="/BookMyRoom/admin/staffs/add" class="space-y-4"> <!-- Họ tên -->
          <div>
          ...
          <div class="flex justify-end space-x-3 pt-4">
            <button type="button" id="cancelBtn_staff"
  ...
  <!-- Modal sửa đối tác -->
  <div id="editStaffsModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
      <div class="mt-3">
        <div class="flex items-center justify-between mb-4">
          <h3 class="text-lg font-medium text-gray-900">Sửa đối tác</h3>
          <button id="closeEditModal_staff" class="text-gray-400 hover:text-gray-600">
            <span class="text-2xl">&times;</span>
          </button>
        </div>

        <form id="editStaffsForm" class="space-y-4">
          ...
          <!-- Nút hành động -->
          <div class="flex justify-end space-x-3 pt-4">
            <button type="button" id="cancelEditBtn_staff"
              class="px-4 py-2 bg-gray-300 text-gray-700 rounded-md hover:bg-gray-400 focus:ring-2 focus:ring-gray-500">
              Hủy
            </button>
            <button type="submit"
