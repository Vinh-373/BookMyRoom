...
<div class="statisticals-section">
    ...
    <div class="statisticals-summary">
        ...
        <div class="statisticals-card"><h3>Tổng user</h3><p><?= $totalUsers ?></p></div>
        <div class="statisticals-card"><h3>Khách hàng</h3><p><?= $customersCount ?></p></div>
        <div class="statisticals-card"><h3>Đối tác</h3><p><?= $partnersCount ?></p></div>
        <div class="statisticals-card"><h3>Admin</h3><p><?= $adminsCount ?></p></div>

        <div class="statisticals-card"><h3>Khách sạn</h3><p><?= $totalHotels ?></p></div>

        <div class="statisticals-card"><h3>Loại phòng</h3><p><?= $totalRoomConfigs ?></p></div>
        <div class="statisticals-card"><h3>Phòng</h3><p><?= $totalPhysicalRooms ?></p></div>

        <div class="statisticals-card"><h3>Tổng booking</h3><p><?= $totalBookings ?></p></div>
        <div class="statisticals-card"><h3>Hoàn thành</h3><p><?= count($completedBookings) ?></p></div>
        <div class="statisticals-card"><h3>Đang chờ</h3><p><?= count($pendingBookings) ?></p></div>
        <div class="statisticals-card"><h3>Huỷ</h3><p><?= count($cancelledBookings) ?></p></div>
