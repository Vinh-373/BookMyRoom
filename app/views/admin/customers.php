 <div class="customer-container">
   ...
   <div class="customer-stats-grid">
     <div class="customer-stat-card"><?php echo count($partners); ?> Tổng tài khoản</div>
     <div class="customer-stat-card"><?php echo count(array_filter($partners, fn($p) => $p['status'] == 'ACTIVE')); ?> Đang hoạt động</div>
     <div class="customer-stat-card"><?php echo count(array_filter($partners, fn($p) => $p['status'] == 'PENDING')); ?> Đang chờ duyệt</div>
     <div class="customer-stat-card"><?php echo count(array_filter($partners, fn($p) => $p['status'] == 'BLOCKED')); ?> Bị khóa</div>
   </div>
   ...
   <div class="customer-search-filter">
     ...
     <button class="customer-btn-add-partner">+ Thêm đối tác</button>
   </div>
       ...
       <?php foreach ($partners as $partner): ?>
         <tr data-user-id="<?php echo $partner['userId']; ?>">
           ...
           <td>
             ...
             <?php endif; ?>
             <button class="partner-delete-btn" data-user-id="<?php echo $partner['userId']; ?>">Xóa</button>
           </td>
         </tr>
       <?php endforeach; ?>
     </tbody>
