...
class HotelModel extends Model
{
    ...
    {
        // Lấy danh sách khách sạn cơ bản trước
        $sql = "SELECT 
                h.*, 
                c.name as cityName, 
                w.name as wardName,
                -- Lấy ảnh chính hiện ra ngoài danh sách
        ...
        // Gắn thêm mảng images vào từng khách sạn để dùng cho Modal Edit
    ...
    public function insert($data)
    {
        ...
        // Nếu query thành công, trả về ID vừa tạo, ngược lại trả về false
    ...
    // Xóa tất cả ảnh của khách sạn (Dùng khi update để thay bộ ảnh mới)
    ...
    // Lấy danh sách ảnh của 1 khách sạn (Dùng để load vào Modal khi sửa)
